<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $update = mysqli_query($db, "UPDATE kpop SET nama_album='$nama_album', jumlah_album='$jumlah_album', nama_customer='$nama_customer', no_telepon='$no_telepon' WHERE id='$id'");
...
<body>
    ...
    <div class="form-class">
        ...
        <form action="" method="post">
            ...
            <textarea name="no_telepon" id="" cols="135" rows="10" value=<?=$row['no_telepon'];?>></textarea><br>
